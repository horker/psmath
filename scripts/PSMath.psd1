#
# Module manifest for module 'PSMath'
#
# Generated by: horker
#
...
GUID = 'e356c4e7-b682-4008-938b-0b81db760c4b'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = @(
          'Accord', 'Accord.NET',
          'math', 'statistics', 'statistical',
          'sin', 'cos', 'exp', 'pow', 'sqrt', 'pi', 'matrix',
          'mean', 'variance', 'standard', 'deviation',
          'normal', 'chi', 'squire', 'f', 't', 'distribution',
          'binomial', 'fisher', 'anova',
          'hypothesis', 'testing',
          'linear', 'logistic', 'regression'
        )

        # A URL to the license for this module.
        LicenseUri = 'https://opensource.org/licenses/LGPL-2.1'

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/horker/psmath'
