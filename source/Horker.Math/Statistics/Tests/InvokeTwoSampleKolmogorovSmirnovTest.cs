...
{
    [Cmdlet("Invoke", "TwoSampleKolmogorovSmirnovTest")]
    [CmdletBinding(DefaultParameterSetName = "Pipeline")]
    public class InvokeTwoSampleKolmogorovSmirnovTest : PSCmdlet
    {
        ...
        {
            var hypo = TestingHelper.GetTwoSampleKolmogorovSmirnovTestHypothesis(Alternate);

            TwoSampleKolmogorovSmirnovTest test;

            if (ParameterSetName == "Pipeline") {
                test = new TwoSampleKolmogorovSmirnovTest(_data[Sample1Name].ToDoubleArray(), _data[Sample2Name].ToDoubleArray(), hypo);
            }
            else {
                test = new TwoSampleKolmogorovSmirnovTest(Sample1, Sample2, hypo);
            }
